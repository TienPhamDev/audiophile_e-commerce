    ...
    <div class="container">
      <header class="header-product-details">
        ...
        <ul id='menu-desktop' class=" ${isTablet ? "hidden" : ""}">
          ...
          <li><a href="${URL}/allproducts" data-link >All Products</a></li>
        ...
        <ul id="menu-tablet" class='menu ${isDesktop ? "hidden" : ""}'>
          ...
          <li class="menu-allproducts">
            <a href="${URL}/allproducts" data-link class="button-2 menu-a">All Products</a>
          </li>
            ...
            ${product.others
              .map((item) => {
                ...
                return `<div class="product-details-others-item">
                        ...
                        <h3>${item.name}</h3>
                        <a href="${URL}/${product.category}/${item.slug}" data-link  class="button-1">SEE PRODUCT</a>
                      </div>`;
              })
              .join("")}
              </div>
