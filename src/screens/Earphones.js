...
const Earphones = () => {
  ...
  const newProductData = earphonesData.find((item) => item.new === true);

  const allProductData = earphonesData.filter((item) => item.new === false);
              ...
              if (index % 2 === 0 && !isMobile) {
                ...
                <div class="product-item">
                  <div class="product-info">
                    ...
                    <a href="${URL}/headphones/${item.slug}" class="button-1">SEE PRODUCT</a>
                  </div>
                  <div class="product-image">
...
const initFuncEarphones = () => {
  handleDetectScreenChange();
  HandleMenuButton();
  processingCart();
};
export { Earphones, initFuncEarphones };
