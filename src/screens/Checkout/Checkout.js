...
const Checkout = () => {
  ...
  const totalPrice = checkout
    ...
    .toFixed(2);
  const vatPrice = totalPrice * 0.2; // Assuming VAT is 10% of the total price
          ...
          <div class='checkout-details'>
            <h1>Checkout</h1>
              ...
              <div class="form-group payment-details">
                ...
                <input type='radio' id="payment-method" name="payment-method" value="e-money" checked>  
                <label for="e-money">e-Money</label>
                <input type='radio' id="payment-method" name="payment-method" value="cash-on-delivery">
                <label for="cash-on-delivery">Cash on Delivery</label>
                <div class="e-money-details">
