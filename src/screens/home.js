...
const Home = () => {
  ...
  <div class="container">
    <header class="header-homepage">
      <nav>
        <button id='menu-button' class="menu-button ${isDesktop ? "hidden" : ""}">
          <svg id='menu-open' width="24" height="21" xmlns="http://www.w3.org/2000/svg"><path d="M0 0h24v3H0V0zm0 9h24v3H0V9zm0 9h24v3H0v-3z" fill="#FFF" fill-rule="nonzero"/></svg>
        ...
        <ul id='menu' class="menu ${isTablet ? "hidden" : ""}">
          <li><a href="/">Home</a></li>
        ...
        <div class="product-3rd-item">
          ...
          <div class="product-3rd-item-text-container">
            <div class="product-3rd-item-text">
              <h3>YX1 EARPHONES</h3>
              <a href="/speakers/zx9-speaker" class="button-2">See Product</a>
            </div>
          </div>        
        </div>
      </section>
