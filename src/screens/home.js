    ...
    <div class='overlay-menu ${isDesktop ? "hidden" : ""}'></div>
      ...
      <section class="hero">
        <div class="hero-text">
          ...
          <a href="${URL}/headphones/xx99-mark-two-headphones" class="button-1">See Product</a>
        </div>
      </section>
    </header>
    <main>
      ...
      <section class="products-homepage">
        <div class="product-1st-item">
          ...
          <div class="product-1st-item-text">
            ...
            <a href="${URL}/speakers/zx9-speaker" class="button-3">See Product</a>
          </div>        
        </div>
        <div class="product-2nd-item">
          ...
          <div class="product-2nd-item-text">
            <h3>ZX7 SPEAKER</h3>
            <a href="${URL}/speakers/zx7-speaker" class="button-2">See Product</a>
          </div>
        </div>
        <div class="product-3rd-item">
          <img src=${imgEarphoneYX1} alt="yx1 earphones">
          <div class="product-3rd-item-text-container">
            <div class="product-3rd-item-text">
              <h3>YX1 EARPHONES</h3>
              <a href="${URL}/speakers/zx9-speaker" class="button-2">See Product</a>
            </div>
          </div>        
        </div>
      </section>
